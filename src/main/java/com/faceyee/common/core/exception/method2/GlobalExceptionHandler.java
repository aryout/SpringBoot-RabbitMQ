package com.faceyee.common.core.exception.method2;

import com.faceyee.common.core.utils.LocaleMessageUtil;
import com.faceyee.common.core.result.RestServiceError;
...
//        }
        ...
        }else if (de instanceof UnAuthExcetion){
            return localeMessageUtil.getLocalErrorMessage(RestServiceError.Type.UNAUTHERROR);
        }
